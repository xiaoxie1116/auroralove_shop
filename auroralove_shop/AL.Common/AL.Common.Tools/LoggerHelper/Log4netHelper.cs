...
namespace AL.Common.Tools.LoggerHelper
{
    ...
    public class Singleton
    {
        ...
        {
            Log = LogManager.GetLogger(Log4netHelper._repository.Name, type);
            return Log;
        }
    }
    ...
    public class Log4netHelper
    {
        ...
        {
            _repository = LogManager.CreateRepository("NETCoreLog4netRepository");
            var file = new FileInfo(System.IO.Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "log4net.config"));
            log4net.Config.XmlConfigurator.Configure(_repository, file);
        }
